...
namespace SimiSoft
{
    public class SimiSoftContext : XpoContext
    {
        public SimiSoftContext(string s1, string s2, IDataLayer dataLayer)
    ...
    [JSONPSupportBehavior]
#endif
    public class SimiSoftService : XpoDataServiceV3
    {
        static readonly SimiSoftContext serviceContext = new SimiSoftContext("SimiSoftService", "SimiSoft", CreateDataLayer());

        public SimiSoftService() : base(serviceContext, serviceContext) { }
